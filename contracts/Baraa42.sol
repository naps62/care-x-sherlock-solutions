...
// interface IChallenge_Baraa42 {}

// contract Exploit_Baraa42 {
//     IChallenge_Baraa42 instance;

//     constructor(IChallenge_Baraa42 _instance) payable {
//         instance = _instance;
//         casino = new Casino();
//     }
...
//     function gameOn() public view returns (bool) {
//         return casino.gameOn();
//     }

//     function cond1() public view returns (bool) {
//         return address(casino).balance > casino.totalDeposits() + casino.totalPrize() + casino.totalJackpot();
//     }

//     function cond2() public view returns (bool) {
//         return address(casino).balance > casino.totalDeposits() + (casino.totalPrize() * 25) / 100 + casino.totalJackpot();
//     }
// }
...
//         bytes32 _hash;
//         for (uint256 i = 0; i < tickets.length; i++) {
//             _hash = keccak256(abi.encodePacked(_hash, tickets[i].player, tickets[i].timestamp, tickets[i].chance, tickets[i].player.balance));
//         }
